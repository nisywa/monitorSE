...
export default function MainLayout({ children, title = '' }) {
    ...
    // Admin menus - organized by category
    const adminMenus = [
        {
            category: 'Dashboard',
            items: [
    ...
    return (
        <div className="flex h-screen bg-gray-100 font-sans overflow-hidden">
                            ...
                            <div className="space-y-1">
                                {category.items.map((menu) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <span className="shrink-0 flex items-center justify-center">{menu.icon}</span>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center gap-2.5 px-2 py-1.5 min-w-0">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <span
                                        className={`text-xs px-1.5 py-0.5 rounded font-medium ${roleColor[role]} inline-block`}
                                    >
                                        {roleLabel[role]}
                                    </span>
                                </div>
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                {/* Top Bar - Responsive */}
                <header className="bg-white border-b border-gray-200 px-4 md:px-6 py-3 md:py-4 flex items-center gap-4 shrink-0">
                    <button
